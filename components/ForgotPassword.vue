    ...
    <h1 class="text-lg font-bold text-center mb-6 text-primary">Recuperar Contraseña</h1>
      <form class="space-y-4" @submit.prevent="forgotPassword">
        ...
        <div class="flex items-center justify-end mt-6 gap-4">
          <button type="submit" class="text-white bg-primary hover:bg-secondary focus:ring-4 focus:ring-primary font-medium rounded-lg text-sm px-5 py-2.5 text-center">Resetear Contraseña</button>
        </div>
      </form>
